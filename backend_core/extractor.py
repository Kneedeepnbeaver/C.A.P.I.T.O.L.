...
# --- CONFIGURATION ---
# Use config module instead of hardcoded paths
INPUT_DIR = config.TEXT_DIR
OUTPUT_CSV = config.METADATA_CSV
# We will use the same directory for json as csv
OUTPUT_JSON = config.METADATA_CSV.with_suffix('.json') 
...
def run_extraction():
    ...
    if not input_path.exists():
        print(f"Docs directory not found: {input_path}")
        return
